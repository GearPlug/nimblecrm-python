# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-08-24 19:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gear', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gear', to='gp.Gear')),
            ],
        ),
        migrations.CreateModel(
            name='GearMapData',
            fields=[
                ...
                ('gear_map', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gear_map', to='gp.GearMap')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AlterUniqueTogether(
            name='storeddata',
            unique_together=set([('connection', 'object_id', 'name')]),
        ),
        migrations.AlterUniqueTogether(
            name='plugspecification',
