    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='created')),
                ('current_fee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fee_service_validity', to='billing.ServiceFee')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='service_validity', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
