...
class CreatePlugView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form, *args, **kwargs):
        ...
        if ping:
            ...
            print(data_list)
        # if self.object.action.connector.id == ConnectorEnum.Facebook.value:
        #     print("is Facebook")
        # elif self.object.action.connector.id == ConnectorEnum.MySQL.value:
        #     print("is MySQL")
        # elif self.object.action.connector.id == ConnectorEnum.SugarCRM.value:
        #     specification_list = ['module-name']
        # elif self.object.action.connector.id == ConnectorEnum.MailChimp.value:
        #     print("is MailChimp")
        # elif self.object.action.connector.id == ConnectorEnum.GoogleSpreadSheets.value:
        #     print("is Google")
        # raise IndexError(self.get_success_url())
