...
from apps.connection.views import CreateConnectionView, ListConnectionView, ListConnectorView, AuthSuccess, \
    ...
    ShopifyAuthView, EvernoteAuthView, AsanaAuthView, MercadoLibreAuthView, MailchimpAuthView, WunderListAuthView, \
    HubspotAuthView, AjaxMercadoLibrePostSiteView  # ,AJAXGetSurveyListView,
